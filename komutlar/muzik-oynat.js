...
const db = require("quick.db");
 let aktif = db.has(`lang_${message.guild.id}`) === true;
    ...
    .setColor("RANDOM")
    .setDescription("**<:Yorum_x:786578064561012746> Dinlemek istediğin şarkıyı yazmalısın! (Şarkı ismi veya Youtube URLsi)**")
    ...
    if (!permissions.has('SPEAK')) {
      ...
      .setColor("RANDOM")
      .setDescription(`<:Yorum_tik:786578062955118612> [${playlist.title}](https://www.youtube.com/watch?v=${playlist.id}) adlı şarkı oynatma listesine Eklendi!`)
